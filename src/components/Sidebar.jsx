const Sidebar = () => {
  return (
    <div id='sidebar' className='bg-white fixed top-0 right-0 z-50 h-screen w-full md:w-3/5 lg:w-2/5 shadow-2xl p-8 flex flex-col'>
      ...
      <div className='max-h-[72vh] overflow-auto pt-8 border-t border-zinc-300 flex flex-col gap-16'>
        ...
        </div>        <div className='flex gap-4 justify-between p-2'>
          <img
            src='https://fakestoreapi.com/img/71li-ujtlUL._AC_UX679_t.png'
            alt=''
            className='w-20'
